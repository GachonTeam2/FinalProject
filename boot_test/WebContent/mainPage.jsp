...
<body>
	<div class="container">
				...
				<div class="navbar-inner navbar-fixed-top">
					<div class="container">
						<ul class="nav">
							...
							<li><a href="index.jsp">SCABTRS</a></li>
							<li><a href="mypage.jsp"><i class="icon-user"></i></a></li>
							<li><a href="writepage.jsp"><i class="icon-pencil"></i></a></li>
		...
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				...
				<div class="item active">
					<img
						src="http://postfiles9.naver.net/20150705_40/kyg91kr_1436087630847ASvHG_JPEG/2015_07_05_-_%C8%AB%B8%AA%BC%F6%B8%F1%BF%F8017.jpg?type=w1"
						alt="">
					<div class="container">
			...
			<div class="accordion-group">
				...
				<div id="collapseOne" class="accordion-body collapse">
					<div class="accordion-inner raw-fluid">
						...
						<div class="span2">
							<input type="checkbox" name=location value="seoul">
							Kyonggi
						</div>
						<div class="span2">
							<input type="checkbox" name=location value="seoul">
		...
		<jsp:useBean id="regMgr" class="boot.RegisterMgr" scope="page" />
...
%>
			<div class="span4">
				<h2><%=regBean.getTitle()%></h2>
				<img src="<%=regBean.getFirstimage()%>" class="img-polaroid">
				<p><%=regBean.getAddr1() %></p>
				<p>
