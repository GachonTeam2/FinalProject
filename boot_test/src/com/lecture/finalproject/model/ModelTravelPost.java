...
public class ModelTravelPost {
	...
	public ModelTravelPost(int travelPost_no, String title, String travelPost_date, int view_count, String user_id) {
		super();
	...
	public String toString() {
		return "ModelTravelPost [travelPost_no=" + travelPost_no + ", title=" + title + ", travelPost_date="
				+ travelPost_date + ", view_count=" + view_count + ", user_id=" + user_id + "]";
	}
